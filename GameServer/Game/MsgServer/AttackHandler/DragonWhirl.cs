                    ...
                    case (ushort)Role.Flags.SpellID.DragonWhirl:
                        {
                            ...
                            Algoritms.InLineAlgorithm Line = new Algoritms.InLineAlgorithm(user.Player.X, Attack.X, user.Player.Y, Attack.Y, DBSpell.Range, Algoritms.InLineAlgorithm.Algorithm.DDA);
