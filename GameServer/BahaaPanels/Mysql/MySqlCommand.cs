...
namespace COServer.Database
{
    ...
    public unsafe class MySqlCommand : IDisposable
    {
        ...
        public int Execute()
        {
            ...
            {
                conn.ConnectionString = "Server=localhost;Port=3306;Database=zq;Uid=root;Password=anderson;Persist Security Info=True;Pooling=true; Min Pool Size = 32;  Max Pool Size = 300;";
                conn.Open();
